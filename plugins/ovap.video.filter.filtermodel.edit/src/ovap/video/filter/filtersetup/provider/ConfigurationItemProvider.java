...
/**
 * This is the item provider adapter for a {@link ovap.video.filter.filtersetup.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FiltersetupPackage.Literals.CONFIGURATION__ENTRIES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Configuration.class)) {
			case FiltersetupPackage.CONFIGURATION__ENTRIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FiltersetupPackage.Literals.CONFIGURATION__ENTRIES,
				 FiltersetupFactory.eINSTANCE.create(FiltersetupPackage.Literals.CONFIGURATION_MAP_ENTRY)));
	}
