...
/**
 * This is the item provider adapter for a {@link ovap.video.filter.filtersetup.Identifiable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdentifiableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Identifiable_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Identifiable_name_feature", "_UI_Identifiable_type"),
				 FiltersetupPackage.Literals.IDENTIFIABLE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Identifiable.class)) {
			case FiltersetupPackage.IDENTIFIABLE__NAME:
