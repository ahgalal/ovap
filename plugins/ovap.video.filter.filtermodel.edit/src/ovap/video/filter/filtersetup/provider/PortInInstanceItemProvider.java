	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PortInInstance_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PortInInstance_type_feature", "_UI_PortInInstance_type"),
				 FiltersetupPackage.Literals.PORT_IN_INSTANCE__TYPE,
				 true,
				 false,
				 true,
				 null,
