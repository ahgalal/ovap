...
/**
 * This is the item provider adapter for a {@link ovap.video.filter.filtersetup.FilterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FilterTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FiltersetupPackage.Literals.FILTER_TYPE__PORT_OUT);
			childrenFeatures.add(FiltersetupPackage.Literals.FILTER_TYPE__PORT_IN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FiltersetupPackage.Literals.FILTER_TYPE__PORT_OUT,
				 FiltersetupFactory.eINSTANCE.createPortOut()));

		newChildDescriptors.add
			(createChildParameter
				(FiltersetupPackage.Literals.FILTER_TYPE__PORT_IN,
				 FiltersetupFactory.eINSTANCE.createPortIn()));
	}
