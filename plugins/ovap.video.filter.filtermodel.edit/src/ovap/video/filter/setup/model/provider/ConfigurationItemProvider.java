...
/**
 * This is the item provider adapter for a {@link ovap.video.filter.setup.model.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.CONFIGURATION__ENTRIES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Configuration.class)) {
			case ModelPackage.CONFIGURATION__ENTRIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CONFIGURATION__ENTRIES,
				 ModelFactory.eINSTANCE.create(ModelPackage.Literals.CONFIGURATION_MAP_ENTRY)));
	}
