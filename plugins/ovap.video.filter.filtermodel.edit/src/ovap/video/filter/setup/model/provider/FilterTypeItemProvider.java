...
/**
 * This is the item provider adapter for a {@link ovap.video.filter.setup.model.FilterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FilterTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.FILTER_TYPE__PORT_OUT);
			childrenFeatures.add(ModelPackage.Literals.FILTER_TYPE__PORT_IN);
		}
	...
	public String getText(Object object) {
		String label = ((FilterType)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.FILTER_TYPE__PORT_OUT,
				 ModelFactory.eINSTANCE.createPortOut()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.FILTER_TYPE__PORT_IN,
				 ModelFactory.eINSTANCE.createPortIn()));
	}
