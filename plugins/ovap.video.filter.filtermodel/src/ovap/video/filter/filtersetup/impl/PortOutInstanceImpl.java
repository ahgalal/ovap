 ...
 * <ul>
 *   <li>{@link ovap.video.filter.filtersetup.impl.PortOutInstanceImpl#getFilterInstance <em>Filter Instance</em>}</li>
 *   <li>{@link ovap.video.filter.filtersetup.impl.PortOutInstanceImpl#getFilterConnection <em>Filter Connection</em>}</li>
 *   <li>{@link ovap.video.filter.filtersetup.impl.PortOutInstanceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PortOutInstanceImpl extends PortInstanceImpl implements PortOutInstance {
	...
	protected EClass eStaticClass() {
		return FiltersetupPackage.Literals.PORT_OUT_INSTANCE;
	}
	...
	public FilterInstance getFilterInstance() {
		if (eContainerFeatureID() != FiltersetupPackage.PORT_OUT_INSTANCE__FILTER_INSTANCE) return null;
	...
	public NotificationChain basicSetFilterInstance(FilterInstance newFilterInstance, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newFilterInstance, FiltersetupPackage.PORT_OUT_INSTANCE__FILTER_INSTANCE, msgs);
		return msgs;
	}
	...
	public void setFilterInstance(FilterInstance newFilterInstance) {
		if (newFilterInstance != eInternalContainer() || (eContainerFeatureID() != FiltersetupPackage.PORT_OUT_INSTANCE__FILTER_INSTANCE && newFilterInstance != null)) {
			...
			if (newFilterInstance != null)
				msgs = ((InternalEObject)newFilterInstance).eInverseAdd(this, FiltersetupPackage.FILTER_INSTANCE__PORT_OUT_INSTANCE, FilterInstance.class, msgs);
			msgs = basicSetFilterInstance(newFilterInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersetupPackage.PORT_OUT_INSTANCE__FILTER_INSTANCE, newFilterInstance, newFilterInstance));
	}
	...
	public EList<FilterConnection> getFilterConnection() {
		if (filterConnection == null) {
			filterConnection = new EObjectWithInverseResolvingEList<FilterConnection>(FilterConnection.class, this, FiltersetupPackage.PORT_OUT_INSTANCE__FILTER_CONNECTION, FiltersetupPackage.FILTER_CONNECTION__PORT_OUT_INSTANCE);
		}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FiltersetupPackage.PORT_OUT_INSTANCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(PortOut newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersetupPackage.PORT_OUT_INSTANCE__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FiltersetupPackage.PORT_OUT_INSTANCE__FILTER_INSTANCE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetFilterInstance((FilterInstance)otherEnd, msgs);
			case FiltersetupPackage.PORT_OUT_INSTANCE__FILTER_CONNECTION:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FiltersetupPackage.PORT_OUT_INSTANCE__FILTER_INSTANCE:
				return eInternalContainer().eInverseRemove(this, FiltersetupPackage.FILTER_INSTANCE__PORT_OUT_INSTANCE, FilterInstance.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FiltersetupPackage.PORT_OUT_INSTANCE__TYPE:
