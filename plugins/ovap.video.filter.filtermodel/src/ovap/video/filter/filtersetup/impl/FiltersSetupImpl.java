 ...
 * <ul>
 *   <li>{@link ovap.video.filter.filtersetup.impl.FiltersSetupImpl#getFilterInstances <em>Filter Instances</em>}</li>
 *   <li>{@link ovap.video.filter.filtersetup.impl.FiltersSetupImpl#getConnections <em>Connections</em>}</li>
 *   <li>{@link ovap.video.filter.filtersetup.impl.FiltersSetupImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FiltersSetupImpl extends IdentifiableImpl implements FiltersSetup {
	...
	protected EClass eStaticClass() {
		return FiltersetupPackage.Literals.FILTERS_SETUP;
	}
	...
	public EList<FilterInstance> getFilterInstances() {
		if (filterInstances == null) {
			filterInstances = new EObjectContainmentEList<FilterInstance>(FilterInstance.class, this, FiltersetupPackage.FILTERS_SETUP__FILTER_INSTANCES);
		}
	...
	public EList<FilterConnection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentWithInverseEList<FilterConnection>(FilterConnection.class, this, FiltersetupPackage.FILTERS_SETUP__CONNECTIONS, FiltersetupPackage.FILTER_CONNECTION__FILTERS_SETUP);
		}
		return connections;
	}
	...
	public FilterModel getModel() {
		if (eContainerFeatureID() != FiltersetupPackage.FILTERS_SETUP__MODEL) return null;
	...
	public NotificationChain basicSetModel(FilterModel newModel, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newModel, FiltersetupPackage.FILTERS_SETUP__MODEL, msgs);
		return msgs;
	}
	...
	public void setModel(FilterModel newModel) {
		if (newModel != eInternalContainer() || (eContainerFeatureID() != FiltersetupPackage.FILTERS_SETUP__MODEL && newModel != null)) {
			...
			if (newModel != null)
				msgs = ((InternalEObject)newModel).eInverseAdd(this, FiltersetupPackage.FILTER_MODEL__SETUP, FilterModel.class, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersetupPackage.FILTERS_SETUP__MODEL, newModel, newModel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FiltersetupPackage.FILTERS_SETUP__CONNECTIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getConnections()).basicAdd(otherEnd, msgs);
			case FiltersetupPackage.FILTERS_SETUP__MODEL:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FiltersetupPackage.FILTERS_SETUP__FILTER_INSTANCES:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FiltersetupPackage.FILTERS_SETUP__MODEL:
				return eInternalContainer().eInverseRemove(this, FiltersetupPackage.FILTER_MODEL__SETUP, FilterModel.class, msgs);
		}
