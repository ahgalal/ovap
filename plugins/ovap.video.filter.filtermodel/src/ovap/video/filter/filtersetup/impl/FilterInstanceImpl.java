 ...
 * <ul>
 *   <li>{@link ovap.video.filter.filtersetup.impl.FilterInstanceImpl#getType <em>Type</em>}</li>
 *   <li>{@link ovap.video.filter.filtersetup.impl.FilterInstanceImpl#getPortInInstance <em>Port In Instance</em>}</li>
 *   <li>{@link ovap.video.filter.filtersetup.impl.FilterInstanceImpl#getPortOutInstance <em>Port Out Instance</em>}</li>
 *   <li>{@link ovap.video.filter.filtersetup.impl.FilterInstanceImpl#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FilterInstanceImpl extends IdentifiableImpl implements FilterInstance {
	...
	protected EClass eStaticClass() {
		return FiltersetupPackage.Literals.FILTER_INSTANCE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FiltersetupPackage.FILTER_INSTANCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(FilterType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersetupPackage.FILTER_INSTANCE__TYPE, oldType, type));
	}
	...
	public EList<PortInInstance> getPortInInstance() {
		if (portInInstance == null) {
			portInInstance = new EObjectContainmentWithInverseEList<PortInInstance>(PortInInstance.class, this, FiltersetupPackage.FILTER_INSTANCE__PORT_IN_INSTANCE, FiltersetupPackage.PORT_IN_INSTANCE__FILTER_INSTANCE);
		}
	...
	public EList<PortOutInstance> getPortOutInstance() {
		if (portOutInstance == null) {
			portOutInstance = new EObjectContainmentWithInverseEList<PortOutInstance>(PortOutInstance.class, this, FiltersetupPackage.FILTER_INSTANCE__PORT_OUT_INSTANCE, FiltersetupPackage.PORT_OUT_INSTANCE__FILTER_INSTANCE);
		}
	...
	public NotificationChain basicSetConfiguration(Configuration newConfiguration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FiltersetupPackage.FILTER_INSTANCE__CONFIGURATION, oldConfiguration, newConfiguration);
	...
	public void setConfiguration(Configuration newConfiguration) {
		if (newConfiguration != configuration) {
			...
			if (configuration != null)
				msgs = ((InternalEObject)configuration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FiltersetupPackage.FILTER_INSTANCE__CONFIGURATION, null, msgs);
			if (newConfiguration != null)
				msgs = ((InternalEObject)newConfiguration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FiltersetupPackage.FILTER_INSTANCE__CONFIGURATION, null, msgs);
			msgs = basicSetConfiguration(newConfiguration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersetupPackage.FILTER_INSTANCE__CONFIGURATION, newConfiguration, newConfiguration));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FiltersetupPackage.FILTER_INSTANCE__PORT_IN_INSTANCE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getPortInInstance()).basicAdd(otherEnd, msgs);
			case FiltersetupPackage.FILTER_INSTANCE__PORT_OUT_INSTANCE:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FiltersetupPackage.FILTER_INSTANCE__CONFIGURATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FiltersetupPackage.FILTER_INSTANCE__TYPE:
