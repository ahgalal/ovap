 ...
 * <ul>
 *   <li>{@link ovap.video.filter.filtersetup.impl.PortInInstanceImpl#getFilterInstance <em>Filter Instance</em>}</li>
 *   <li>{@link ovap.video.filter.filtersetup.impl.PortInInstanceImpl#getFilterConnection <em>Filter Connection</em>}</li>
 *   <li>{@link ovap.video.filter.filtersetup.impl.PortInInstanceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PortInInstanceImpl extends PortInstanceImpl implements PortInInstance {
	...
	protected EClass eStaticClass() {
		return FiltersetupPackage.Literals.PORT_IN_INSTANCE;
	}
	...
	public FilterInstance getFilterInstance() {
		if (eContainerFeatureID() != FiltersetupPackage.PORT_IN_INSTANCE__FILTER_INSTANCE) return null;
	...
	public NotificationChain basicSetFilterInstance(FilterInstance newFilterInstance, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newFilterInstance, FiltersetupPackage.PORT_IN_INSTANCE__FILTER_INSTANCE, msgs);
		return msgs;
	}
	...
	public void setFilterInstance(FilterInstance newFilterInstance) {
		if (newFilterInstance != eInternalContainer() || (eContainerFeatureID() != FiltersetupPackage.PORT_IN_INSTANCE__FILTER_INSTANCE && newFilterInstance != null)) {
			...
			if (newFilterInstance != null)
				msgs = ((InternalEObject)newFilterInstance).eInverseAdd(this, FiltersetupPackage.FILTER_INSTANCE__PORT_IN_INSTANCE, FilterInstance.class, msgs);
			msgs = basicSetFilterInstance(newFilterInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersetupPackage.PORT_IN_INSTANCE__FILTER_INSTANCE, newFilterInstance, newFilterInstance));
	}
		...
		if (filterConnection != null && filterConnection.eIsProxy()) {
			...
			if (filterConnection != oldFilterConnection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FiltersetupPackage.PORT_IN_INSTANCE__FILTER_CONNECTION, oldFilterConnection, filterConnection));
			}
		}
	...
	public NotificationChain basicSetFilterConnection(FilterConnection newFilterConnection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FiltersetupPackage.PORT_IN_INSTANCE__FILTER_CONNECTION, oldFilterConnection, newFilterConnection);
	...
	public void setFilterConnection(FilterConnection newFilterConnection) {
		if (newFilterConnection != filterConnection) {
			...
			if (filterConnection != null)
				msgs = ((InternalEObject)filterConnection).eInverseRemove(this, FiltersetupPackage.FILTER_CONNECTION__PORT_IN_INSTANCE, FilterConnection.class, msgs);
			if (newFilterConnection != null)
				msgs = ((InternalEObject)newFilterConnection).eInverseAdd(this, FiltersetupPackage.FILTER_CONNECTION__PORT_IN_INSTANCE, FilterConnection.class, msgs);
			msgs = basicSetFilterConnection(newFilterConnection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersetupPackage.PORT_IN_INSTANCE__FILTER_CONNECTION, newFilterConnection, newFilterConnection));
	}
	...
	public PortIn getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FiltersetupPackage.PORT_IN_INSTANCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(PortIn newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersetupPackage.PORT_IN_INSTANCE__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FiltersetupPackage.PORT_IN_INSTANCE__FILTER_INSTANCE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetFilterInstance((FilterInstance)otherEnd, msgs);
			case FiltersetupPackage.PORT_IN_INSTANCE__FILTER_CONNECTION:
				if (filterConnection != null)
					msgs = ((InternalEObject)filterConnection).eInverseRemove(this, FiltersetupPackage.FILTER_CONNECTION__PORT_IN_INSTANCE, FilterConnection.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FiltersetupPackage.PORT_IN_INSTANCE__FILTER_INSTANCE:
				return eInternalContainer().eInverseRemove(this, FiltersetupPackage.FILTER_INSTANCE__PORT_IN_INSTANCE, FilterInstance.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FiltersetupPackage.PORT_IN_INSTANCE__TYPE:
