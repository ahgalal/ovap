 ...
 * <ul>
 *   <li>{@link ovap.video.filter.filtersetup.impl.IdentifiableImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdentifiableImpl extends EObjectImpl implements Identifiable {
	...
	protected EClass eStaticClass() {
		return FiltersetupPackage.Literals.IDENTIFIABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersetupPackage.IDENTIFIABLE__NAME, oldName, name));
	}
