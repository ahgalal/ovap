 ...
 * <ul>
 *   <li>{@link ovap.video.filter.filtersetup.impl.ConfigurationImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConfigurationImpl extends EObjectImpl implements Configuration {
	...
	protected EClass eStaticClass() {
		return FiltersetupPackage.Literals.CONFIGURATION;
	}
	...
	public EMap<String, String> getEntries() {
		if (entries == null) {
			entries = new EcoreEMap<String,String>(FiltersetupPackage.Literals.CONFIGURATION_MAP_ENTRY, ConfigurationMapEntryImpl.class, this, FiltersetupPackage.CONFIGURATION__ENTRIES);
		}
		return entries;
	}
