 ...
 * @generated
 */
public class FiltersetupPackageImpl extends EPackageImpl implements FiltersetupPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ovap.video.filter.filtersetup.FiltersetupPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FiltersetupPackageImpl() {
		super(eNS_URI, FiltersetupFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link FiltersetupPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FiltersetupPackage init() {
		if (isInited) return (FiltersetupPackage)EPackage.Registry.INSTANCE.getEPackage(FiltersetupPackage.eNS_URI);

		// Obtain or create and register package
		FiltersetupPackageImpl theFiltersetupPackage = (FiltersetupPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FiltersetupPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FiltersetupPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theFiltersetupPackage.createPackageContents();

		// Initialize created meta-data
		theFiltersetupPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theFiltersetupPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FiltersetupPackage.eNS_URI, theFiltersetupPackage);
		return theFiltersetupPackage;
	}
	 ...
	 * @generated
	 */
	public FiltersetupFactory getFiltersetupFactory() {
		return (FiltersetupFactory)getEFactoryInstance();
	}
