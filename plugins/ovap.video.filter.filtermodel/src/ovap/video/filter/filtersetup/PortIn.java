 ...
 * <ul>
 *   <li>{@link ovap.video.filter.filtersetup.PortIn#getFilterType <em>Filter Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see ovap.video.filter.filtersetup.FiltersetupPackage#getPortIn()
 * @model
 * @generated
 */
public interface PortIn extends Port {
	 ...
	 * It is bidirectional and its opposite is '{@link ovap.video.filter.filtersetup.FilterType#getPortIn <em>Port In</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ovap.video.filter.filtersetup.FiltersetupPackage#getPortIn_FilterType()
	...
	/**
	 * Sets the value of the '{@link ovap.video.filter.filtersetup.PortIn#getFilterType <em>Filter Type</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
