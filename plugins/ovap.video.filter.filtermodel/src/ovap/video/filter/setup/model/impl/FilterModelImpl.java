 ...
 * <ul>
 *   <li>{@link ovap.video.filter.setup.model.impl.FilterModelImpl#getFilterTypes <em>Filter Types</em>}</li>
 *   <li>{@link ovap.video.filter.setup.model.impl.FilterModelImpl#getSetup <em>Setup</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FilterModelImpl extends IdentifiableImpl implements FilterModel {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.FILTER_MODEL;
	}
	...
	public EList<FilterType> getFilterTypes() {
		if (filterTypes == null) {
			filterTypes = new EObjectContainmentWithInverseEList<FilterType>(FilterType.class, this, ModelPackage.FILTER_MODEL__FILTER_TYPES, ModelPackage.FILTER_TYPE__MODEL);
		}
		return filterTypes;
	}
	...
	public NotificationChain basicSetSetup(FiltersSetup newSetup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.FILTER_MODEL__SETUP, oldSetup, newSetup);
	...
	public void setSetup(FiltersSetup newSetup) {
		if (newSetup != setup) {
			...
			if (setup != null)
				msgs = ((InternalEObject)setup).eInverseRemove(this, ModelPackage.FILTERS_SETUP__MODEL, FiltersSetup.class, msgs);
			if (newSetup != null)
				msgs = ((InternalEObject)newSetup).eInverseAdd(this, ModelPackage.FILTERS_SETUP__MODEL, FiltersSetup.class, msgs);
			msgs = basicSetSetup(newSetup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FILTER_MODEL__SETUP, newSetup, newSetup));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.FILTER_MODEL__FILTER_TYPES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getFilterTypes()).basicAdd(otherEnd, msgs);
			case ModelPackage.FILTER_MODEL__SETUP:
				if (setup != null)
					msgs = ((InternalEObject)setup).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.FILTER_MODEL__SETUP, null, msgs);
