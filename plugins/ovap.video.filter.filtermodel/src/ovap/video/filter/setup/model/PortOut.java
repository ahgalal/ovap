 ...
 * <ul>
 *   <li>{@link ovap.video.filter.setup.model.PortOut#getFilterType <em>Filter Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see ovap.video.filter.setup.model.ModelPackage#getPortOut()
 * @model
 * @generated
 */
public interface PortOut extends Port {
	 ...
	 * It is bidirectional and its opposite is '{@link ovap.video.filter.setup.model.FilterType#getPortOut <em>Port Out</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ovap.video.filter.setup.model.ModelPackage#getPortOut_FilterType()
	...
	/**
	 * Sets the value of the '{@link ovap.video.filter.setup.model.PortOut#getFilterType <em>Filter Type</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
