 ...
 * <ul>
 *   <li>{@link ovap.video.filter.setup.model.PortInInstance#getFilterInstance <em>Filter Instance</em>}</li>
 *   <li>{@link ovap.video.filter.setup.model.PortInInstance#getFilterConnection <em>Filter Connection</em>}</li>
 *   <li>{@link ovap.video.filter.setup.model.PortInInstance#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see ovap.video.filter.setup.model.ModelPackage#getPortInInstance()
 * @model
 * @generated
 */
public interface PortInInstance extends PortInstance {
	 ...
	 * It is bidirectional and its opposite is '{@link ovap.video.filter.setup.model.FilterInstance#getPortInInstance <em>Port In Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ovap.video.filter.setup.model.ModelPackage#getPortInInstance_FilterInstance()
	...
	/**
	 * Sets the value of the '{@link ovap.video.filter.setup.model.PortInInstance#getFilterInstance <em>Filter Instance</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ovap.video.filter.setup.model.FilterConnection#getPortInInstance <em>Port In Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ovap.video.filter.setup.model.ModelPackage#getPortInInstance_FilterConnection()
	...
	/**
	 * Sets the value of the '{@link ovap.video.filter.setup.model.PortInInstance#getFilterConnection <em>Filter Connection</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setType(PortIn)
	 * @see ovap.video.filter.setup.model.ModelPackage#getPortInInstance_Type()
	 * @model required="true"
	 * @generated
	 */
	PortIn getType();
	...
	/**
	 * Sets the value of the '{@link ovap.video.filter.setup.model.PortInInstance#getType <em>Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
